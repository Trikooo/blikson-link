...
export interface YalidineGetTrackingInfo {
...
export interface YalidineGetTrackingInfoQueryParams {
...
export interface YalidineGetTrackingInfoResponseSuccess {
  has_more: boolean;
  total_data: number;
  data: YalidineGetTrackingInfo[];
  links: {
    self: string;
    next?: string;
  };
...
// ❌ Error response
export interface YalidineGetTrackingInfoResponseError {
  error: {
    message: string;
    code: number;
    description: string;
...
export type YalidineGetTrackingInfoResponse =
  | YalidineGetTrackingInfoResponseSuccess
  | YalidineGetTrackingInfoResponseError;
