export interface EcotrackUpdateParcelRequest {
  tracking: string;
  reference?: string;
  client?: string;
  tel?: string;
...
export interface EcotrackUpdateParcelResponseSuccess {
  success: true;
  message: string;
}

export interface EcotrackUpdateParcelResponseError {
  success: false;
  error: number;
  message: string;
}

export type EcotrackUpdateParcelResponse =
